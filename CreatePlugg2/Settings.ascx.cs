...
namespace Christoc.Modules.CreatePlugg2
{
    ...
    /// 
    /// Because the control inherits from CreatePlugg2SettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : CreatePlugg2ModuleSettingsBase
    {
