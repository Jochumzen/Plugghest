...
namespace Plugghest.Modules.Plugghest_Subjects
{
    ...
    /// 
    /// Because the control inherits from Plugghest_SubjectsSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : Plugghest_SubjectsModuleSettingsBase
    {
