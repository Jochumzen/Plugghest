...
namespace Latex2MathML
{
    ...
    public sealed class LatexToMathMLConverter
    {
        ...
        {            
            ...
            PlacementOfTableOfContents = TableOfContentsPlacement.None;
        ...
        {            
            _sourceText = File.ReadAllText(
                "C:\\Users\\Homer\\Documents\\Experiment.tex",
                Encoding.GetEncoding(1251));
            OutputPath = "C:\\Users\\Homer\\Documents\\doc.xhtml";
            CommonInitialize();
        }

        public LatexToMathMLConverter(string source)   //(, Encoding sourceEncoding, string outputPath)
        {
            _sourceText = source;
            OutputPath = "C:\\tmp\\";
            SourcePath = "C:\\tmp\\";
        ...
        /// </summary>
        public string HTMLOutput { get; private set; }
...
/*            CallEventHandler(BeforeXmlFormat);
            ...
            try
            {
                xml = XDocument.Parse(HTMLOutput);
                xml.Save(OutputPath);
            }
            catch (Exception e)
            {
...
// ReSharper restore ConditionIsAlwaysTrueOrFalse
            ...
            {
                File.Copy("C:\\Users\\Homer\\Documents\\My Web Sites\\Latex\\App_Code\\styles.css", destFile, true);
            } */
        }
