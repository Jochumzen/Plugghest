...
namespace Plugghest.Modules.CreatePlugg
{
    ...
    public partial class Edit : CreatePluggModuleBase
    {
        ...
        public void CreateUpdatePluggs(Plugg plug, PlugginContent pluggcontent)
        {
        ...
        public void CreatePlugginContent(PlugginContent pluggcontent, Boolean isUpdate = false) //optional parameter to check for update
        {
            //manage culture code
