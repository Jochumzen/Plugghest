...
using Plugghest.Modules.DNNDal.Components;
...
namespace Plugghest.Modules.DNNDal
{
    ...
    /// 
    /// Because the control inherits from DNNDalModuleBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// 
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class View : DNNDalModuleBase, IActionable
    {
